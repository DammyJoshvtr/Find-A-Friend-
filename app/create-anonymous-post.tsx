...
export default function CreateAnonPostScreen() {
  ...
  const canPost = body.trim().length > 0 && agreed && !posting
        ...
        <ScrollView
          ...
          <View style={s.anonHeader}>
            <View style={s.anonAvatar}>
              <Ionicons name="eye-off-outline" size={20} color="rgba(244,114,182,0.7)" />
            </View>
            <View>
              <Text style={s.anonName}>Anonymous</Text>
              <Text style={s.anonSub}>Your identity is hidden from other students</Text>
            </View>
          </View>
...
const s = StyleSheet.create({
  ...
  postBtn: {
    backgroundColor: '#f472b6', borderRadius: 20,
  ...
  anonHeader: {
    ...
    borderWidth: 0.5, borderColor: 'rgba(244,114,182,0.2)',
  },
  anonAvatar: {
  ...
  checkLabel: { flex: 1, fontSize: 12, color: 'rgba(240,240,255,0.6)', lineHeight: 18 },
