    ...
    <TouchableOpacity
      ...
      <View style={s.body}>
        ...
        <View style={{ flex: 1 }}>
          ...
          <View style={s.meta}>
            <Ionicons name="person-outline" size={11} color="rgba(240,240,255,0.35)" />
            ...
            {group.venue ? (
              <>
                ...
                <Text style={s.metaText} numberOfLines={1}>{group.venue}</Text>
              </>
            ) : null}
          </View>
        </View>
...
const s = StyleSheet.create({
  ...
  name: { fontSize: 13, fontWeight: '600', color: '#f0f0ff', marginBottom: 2 },
  course: { fontSize: 10, color: '#a78bfa', marginBottom: 4 },
  meta: { flexDirection: 'row', alignItems: 'center', gap: 4, flexWrap: 'wrap' },
  metaText: { fontSize: 10, color: 'rgba(240,240,255,0.35)' },
  joinBtn: {
  ...
  fullBtn: { backgroundColor: 'rgba(255,255,255,0.06)', opacity: 0.6 },
