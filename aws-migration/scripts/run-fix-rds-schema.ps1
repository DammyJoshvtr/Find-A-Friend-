# File: aws-migration/scripts/run-fix-rds-schema.ps1
#
...
Write-Output "============================================================"
Write-Output "   Find-A-Friend: Run RDS Database Triggers/Schema Fix"
Write-Output "============================================================"
...
# 2. Package the fix-rds-schema Lambda
Write-Output "[2/5] Packaging Lambda ZIP..."
$tempDir = "aws-migration\temp-fix-rds-schema"
if (Test-Path $tempDir) {
    Remove-Item $tempDir -Recurse -Force
}
New-Item -ItemType Directory -Path $tempDir | Out-Null

Copy-Item "aws-migration\scripts\fix-rds-schema.js" "$tempDir\index.js" -Force
Copy-Item "aws-migration\lambda\node_modules" "$tempDir\node_modules" -Recurse -Force

$zipPath = "aws-migration\vpc_fix_rds_schema_payload.zip"
...
Write-Output "[3/5] Deploying fix-rds-schema Lambda to VPC..."
$funcName = "faf-temp-fix-rds-schema"
...
# 5. Invoke the Lambda
Write-Output "[4/5] Invoking fix-rds-schema Lambda..."
$responseFile = "aws-migration\fix-rds-schema-response.json"
...
Write-Output "============================================================"
Write-Output "   RDS Schema & Triggers Fixed Successfully!"
Write-Output "============================================================"
