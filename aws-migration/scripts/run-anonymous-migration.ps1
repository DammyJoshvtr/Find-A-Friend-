# File: aws-migration/scripts/run-anonymous-migration.ps1
#
# Deploys a temporary Lambda function inside the private VPC to execute the database
# migration queries for the Anonymous Confession Board Admin Dashboard.
...
Write-Output "============================================================"
Write-Output "   Find-A-Friend: Run Anonymous Board DB Migration via VPC"
Write-Output "============================================================"
...
# 2. Package the anonymous-migration Lambda
Write-Output "[2/5] Packaging Lambda ZIP..."
$tempDir = "aws-migration\temp-anon-migration"
if (Test-Path $tempDir) {
    Remove-Item $tempDir -Recurse -Force
}
New-Item -ItemType Directory -Path $tempDir | Out-Null

Copy-Item "aws-migration\scripts\anonymous-migration.js" "$tempDir\index.js" -Force
Copy-Item "aws-migration\lambda\node_modules" "$tempDir\node_modules" -Recurse -Force

$zipPath = "aws-migration\vpc_anonymous_migration_payload.zip"
...
Write-Output "[3/5] Deploying anonymous-migration Lambda to VPC..."
$funcName = "faf-temp-anonymous-migration"
...
# 5. Invoke the Lambda
Write-Output "[4/5] Invoking anonymous-migration Lambda..."
$responseFile = "aws-migration\anonymous-migration-response.json"
...
Write-Output "============================================================"
Write-Output "   DB Migration Completed Successfully!"
Write-Output "============================================================"
